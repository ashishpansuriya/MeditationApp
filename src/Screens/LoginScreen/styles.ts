...
export const styles = StyleSheet.create({
    ...
    button: { justifyContent: 'center', alignSelf: 'center', backgroundColor: Colors.lightBlue, borderRadius: metrics.hp5, height: metrics.hp8, fontSize: RFValue(14), width: widthPercentageToDP('90%'), color: Colors.subtitle, alignItems: 'center', },
